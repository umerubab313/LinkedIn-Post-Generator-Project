...
The input is sent to an LLM via API who is also provided with data of users previous posts so that it can understand writing style

The model generates a structured, professional LinkedIn post
...
Prompt design for structured content generation
